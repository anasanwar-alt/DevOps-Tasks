// ESLint 9 "flat config" — carried over unchanged from Day 5. The old
// .eslintrc.json format is gone in v9; the config is now a plain JS array of
// config objects, applied in order, with later entries overriding earlier ones.
